...
public:
	...
	//void				changeBlueprint(float distance, Blueprint* bp);
	//void				changeBlueprint(uint8_t lod, Blueprint* bp);
	Lod					getLodData(float distance) const;
	Lod					getLodData(uint8_t lod) const;
	Blueprint*			getLodBlueprint(float distance) const;
	Blueprint*			getLodBlueprint(uint8_t lod) const;
